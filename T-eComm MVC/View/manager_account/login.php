    ...
    <div class="container">
        ...
        <div class="form">
            <form action="index.php" method="post">
                <input type="hidden" name="control" value="login_require">
                <div class="lable">
                ...
                <div class="notRemember">
                    ...
                    <a href="index.php?control=register" style="color: orange;">Signup now</a>
                </div>
                <div class="forgotPass">
                    <label style="color: white;">Forgot password?</label>
                    <a href="../../Controller/index.php" style="color: orange;">Click here</a>
                </div>
